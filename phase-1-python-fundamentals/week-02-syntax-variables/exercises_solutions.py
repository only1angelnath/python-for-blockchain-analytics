...
print(f'The token I want to trade name is {token_name} and its symbol is {token_symbol}. It has a total suplly of {total_supply:,} and a ceiculating supply of {circulating_supply_pct}%.')
...
print(f"DEX Swap details: SOld {amount_in:.6f} ETH → For {amount_out:.6f} TOKEN")
